...
@Component({
  selector: 'app-vacantes-client',
  templateUrl: './vacantes-client.component.html',
  styleUrls: ['./vacantes-client.component.css']
})
export class VacantesClientComponent implements OnInit {
  // user: UserInterface;
